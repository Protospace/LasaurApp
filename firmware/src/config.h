...
#define CONFIG_SEEKRATE 2000.0
#define CONFIG_ACCELERATION 4000000 // mm/min^2, typically 1000000-8000000, divide by (60*60) to get mm/sec^2
									// Appears to have minimal effect on cut quality. set to middle value of 4e6
